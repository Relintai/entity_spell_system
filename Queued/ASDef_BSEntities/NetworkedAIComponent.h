...
namespace BS {
	namespace AI {
		class NetworkedAIComponent : public virtual MonoBehaviour, public virtual Object
		{
			...
			public:
				...
				//Ignored empty method declaration
			public:
				NetworkedCharacterController* getCharacterController();
			public:
				void setCharacterController(NetworkedCharacterController* value);
			public:
			...
			public:
				NetworkedCharacterController* CharacterController_var;
			public:
				KinematicCharacterMotor* KinematicCharacterMotor_var;
			public:
				NetworkedAIComponent();
		};
	}
}
