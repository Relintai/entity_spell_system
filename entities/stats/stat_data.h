...
public:
    ...
    Ref<Curve> get_hp_scaling_data();
    void set_hp_scaling_data(Ref<Curve> value);

    Ref<Curve> get_spell_scaling_data();
    void set_spell_scaling_data(Ref<Curve> value);
...
private:
    ...
    Ref<Curve> _hp_scaling_data;
    Ref<Curve> _spell_scaling_data;
